...
function getNewCodeQuery() {
	...
	return sprintf('<a href="https://oauth.vk.com/authorize?client_id=%s&display=page&redirect_uri=%s&scope=%s&responce_type=code&v=5.68" target="_blank">Пройдите по ссылке для получения значения Code</a>',
