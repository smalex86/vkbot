...
$loggingFolder = dirname(dirname(__FILE__)) . '/logs/';
 ...
 * @return boolean
 */
function toLog($msgStatus, $msg, $logFileName = '') {
  global $loggingStatus;
  global $loggingFolder;
  ...
  switch ($msgStatus) {
    case 0: $msgStatusWord = 'IMPORTANT INFO'; break;
    case 1: $msgStatusWord = 'ERROR'; break;
    case 2: $msgStatusWord = 'WARNING'; break;
    case 3: $msgStatusWord = 'DEBUG INFO'; break;
    default: $msgStatusWord = 'UNKNOWN INFO';
  }	
  // записываем сообщение в файл
  return file_put_contents($loggingFolder . $logFileName,  
    sprintf('%s :: %s :: %s'.PHP_EOL, date("Y-m-d H-i-s"), $msgStatusWord, $msg), FILE_APPEND);
}
